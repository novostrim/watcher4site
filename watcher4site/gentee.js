...
//        $state.go( 'login' );
    ...
    $rootScope.msg_quest = function (text, funcyes) {
        this.msg({
            title: lng.confirm, body: text, icon: 'fa-question-circle', icon_class: 'blue',
...
geapp.factory('DbApi', function ($rootScope, $http) {
    ...
    return {
        changefld: function (params, callback) {
            ajaxpost(params, 'changefld', callback)
        },
        delmenu: function (params, callback) {
            ajaxpost(params, 'delmenu', callback)
        },
        droptable: function (params, callback) {
            ajaxpost(params, 'droptable', callback)
        },
        edititem: function (params, callback) {
            ajaxget(params, 'edititem', callback)
        },
        getmenu: function (params, callback) {
            ajaxget(params, 'getmenu', callback)
        },
        getstruct: function (params, callback) {
            ajaxget(params, 'getstruct', callback)
        },
        gettables: function (params, callback) {
            ajaxget(params, 'gettables', callback)
        },
        gettree: function (params, callback) {
            ajaxget(params, 'gettree', callback)
        },
        movemenu: function (params, callback) {
            ajaxpost(params, 'movemenu', callback)
        },
        savefolder: function (params, callback) {
            ajaxpost(params, 'savefolder', callback)
        },
        saveitem: function (params, callback) {
            ajaxpost(params, 'saveitem', callback)
        },
        savemenu: function (params, callback) {
            ajaxpost(params, 'savemenu', callback)
        },
        savestruct: function (params, callback) {
            ajaxpost(params, 'savestruct', callback)
        },
        savedb: function (params, callback) {
            ajaxpost(params, 'savedb', callback)
        },
        saveusr: function (params, callback) {
            ajaxpost(params, 'saveusr', callback)
        },
        table: function (params, callback) {
            ajaxget(params, 'table', callback)
        }
    }
});
